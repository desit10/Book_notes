...
document.querySelector(".addNote").addEventListener("touchstart", function () {
...
document.querySelector(".notes").addEventListener("touchstart", function (e) {
...
let caseColumn;
document.querySelector(".btn-case").addEventListener("touchstart", function () {
  caseColumn = document.querySelector(".case-row");
});

document.querySelector(".addCase").addEventListener("touchstart", function () {
